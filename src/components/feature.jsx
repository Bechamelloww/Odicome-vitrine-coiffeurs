...
const FeatureComponent = () => {
  return (
    <section className="bg-white py-24 sm:py-32" aria-labelledby="feature-heading">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 id="feature-heading" className="text-base font-semibold leading-7 text-indigo-600">Deploy faster</h2>
