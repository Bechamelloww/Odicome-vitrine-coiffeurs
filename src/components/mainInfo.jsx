  ...
  return (
    <>
      ...
      <div className="w-100 flex">
        <img className="h-auto w-fit rounded-lg overflow-hidden shadow-xl dark:shadow-gray-800" src="/app_screen.png" alt="image description" />
      </div>
      ...
      <div className="w-100 flex">
        <img className="h-auto w-fit rounded-lg overflow-hidden shadow-xl dark:shadow-gray-800" src="/createquiz.png" alt="image description" />
      </div>
    </>
  );
};
