      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-8 text-gray-400">Vous avez des questions ou des<br></br> suggestions ? Contactez-nous !</p>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-12 text-sm font-semibold text-gray-400 dark:text-white">Company</h2>
            ...
            <div>
              <h2 className="mb-12 text-sm font-semibold text-gray-400 dark:text-white">Legal</h2>
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
